...
;
//_modules_EIFFAGEUXDesignModules_javascript_navMenu.js_1730068087270.min.js
$(document).ready(function () {

    if ($(document).width() > 1024) {
        $(".subnav__nav-link").hover(function () {
            const element = $(this).data('id');
            if (element) {
                var objects = $(".hover-items");
                ...
                $(".third-elements-detail").css("display", "none");
            } else {
                init();
            }
        }, function () {
        ...
        function init() {
            ...
            $(".third-elements-detail").css("display", "block");
        }
    }

    if ($(document).width() > 1024) {
        $(".subnav__nav-link").hover(function () {
            var elements = document.getElementsByClassName("subnav__nav-link");
            for (let i = 0; i < elements.length; i++) {
                elements[i].classList.add("subnav_hovered");
            }
            $(this).removeClass("subnav_hovered");
        });

        function mouseleaved() {
            var elements = document.getElementsByClassName("subnav__nav-link");
            for (let i = 0; i < elements.length; i++) {
                elements[i].classList.remove("subnav_hovered");
            }
            var objects = $(".hover-items");
            for (var obj of objects) {
                const id = obj.getAttribute('id');
        ...
        $(".subnav_mouse_action").mouseleave(function (e) {
            var element = e.toElement || e.relatedTarget;
            if (!$(element).hasClass('subnav__subnav-link') &&
                !$(element).hasClass('subnav__nav') &&
                !$(element).hasClass('subnav__subnav-li') &&
                !$(element).hasClass('subnav_mouse_action')) {
                mouseleaved();
            }
        });

        $(".subnav_nav_desktop li:last-child").mouseleave(function (e) {
            var $this = $(this);
        ...
        $(".nav__subnav").hover(function () {
            var elements = document.getElementsByClassName("nav__subnav");
            for (let i = 0; i < elements.length; i++) {
                elements[i].classList.remove("parent_hovered");
            }
            $(this).addClass("parent_hovered");
        });
    }
});
;
//_modules_EIFFAGEUXDesignTemplates_javascript_clearDiv.js_1730068112124.min.js
